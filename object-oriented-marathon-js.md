...
- How are visitors going to interact with the water park? What methods might you define to allow them into the exhibit? Are there methods that we can define to keep the visitors and the animals safe?
